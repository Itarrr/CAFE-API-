...
export default function Onboarding() {
  ...
  const finish = () => {
    setState((prev) => ({
      ...
      inventoryItems: [
        { id: generateId(), name: 'コーヒー豆', unit: 'kg', category: '飲料', costPerUnit: 2500 },
        { id: generateId(), name: '牛乳', unit: 'L', category: '乳製品', costPerUnit: 250 },
        { id: generateId(), name: '砂糖', unit: 'kg', category: '調味料', costPerUnit: 300 },
        { id: generateId(), name: 'パン', unit: '個', category: '食材', costPerUnit: 150 },
      ],
    }));
  };
